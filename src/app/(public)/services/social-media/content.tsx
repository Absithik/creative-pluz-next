...
const SocialMediaContent: React.FC = () => {
    ...
    // Local Social Media Images
    const LOCAL_IMAGES = [
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_001.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_002.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_003.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_004.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_005.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_006.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_007.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_008.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_009.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_010.png',
        '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_011.png',
    ];

    // Helper for background columns
    const ScrollingColumn = ({ reverse = false, speed = 40, startIndex = 0 }) => {
        // Create an array of 10 images, cycling through LOCAL_IMAGES starting from startIndex
        const images = [...Array(10)].map((_, i) => LOCAL_IMAGES[(startIndex + i) % LOCAL_IMAGES.length]);
            ...
            <div className="flex flex-col gap-4 h-full overflow-hidden">
                ...
                >
                    ...
                    {[...images, ...images].map((img, i) => (
                        <div key={i} className="aspect-square w-full rounded-xl overflow-hidden">
                            <img src={img} className="w-full h-full object-cover opacity-70" loading="lazy" alt="Social Artifact" />
                        </div>
                    ))}
                </motion.div>
            </div>
    ...
    return (
        <div ref={containerRef} className="bg-black text-white selection:bg-brand-primary selection:text-black">

            {/* --- 1. THE HERO SECTION (UPDATED WITH MOVING COLUMNS) --- */}
            <section className="relative min-h-screen bg-black flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0 flex items-center justify-center">
                    {/* Ambient Background Glow */}
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-primary rounded-full blur-[150px] animate-pulse"></div>

                    {/* Kinetic Scrolling Background Grid */}
                    <div className="flex gap-4  rotate-12 scale-[1.6] md:scale-150 pointer-events-none w-[120vw] h-[120vh]">
            ...
            <section ref={galleryRef} className="py-20 md:py-40 bg-[#030303] overflow-hidden">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
                        {[
                            { title: "Fintech Grid", cat: "Branding", img: '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_011.png' },
                            { title: "Luxe Reels", cat: "Motion", img: '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_010.png' },
                            { title: "FMCG Stories", cat: "Direct Response", img: '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_001.png' },
                            { title: "Crypto Ads", cat: "Campaign", img: '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_002.png' },
                            { title: "Estate Posts", cat: "Interactive", img: '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_007.png' },
                            { title: "Retail Blitz", cat: "Ads", img: '/assets/images/service/SocialMedia/C_PLUS 1000 x 1000 SM_006.png' }
                        ].map((post, i) => (
