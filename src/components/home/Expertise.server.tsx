...
import { ArrowRight, Zap, Box, Share2, Layers } from 'lucide-react';
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
                    ...
                    <div className="lg:w-7/12 flex flex-col gap-8">
                        ...
                        <Link href="/services/branding">
                            <div className="bg-[#0B0B0B] border border-white/10 p-10 rounded-2xl relative overflow-hidden group cursor-pointer transition-transform duration-300 hover:-translate-y-1">
